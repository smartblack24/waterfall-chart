...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-DL7SQ5WE.js";
import {
  ActionBar
} from "./chunk-JSAOGMAX.js";
import "./chunk-NZXCSZ3Y.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-I5WVW5AI.js";
import {
  require_memoizerific
} from "./chunk-Z7KCDGX5.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  require_Set,
  ...
  require_toKey,
  str
} from "./chunk-JKXDTPKA.js";
import {
  require_isObjectLike
} from "./chunk-KEQPWE42.js";
import {
  require_core_events
} from "./chunk-G2IFUJHB.js";
import {
  P
} from "./chunk-NYN7IOPA.js";
import {
  esm_default
...
import {
  ...
  require_isObject,
  require_root
} from "./chunk-YHCR3D3G.js";
import {
  renderElement,
  unmountElement
} from "./chunk-X2OUFFIO.js";
import {
...
import "./chunk-I3HWA624.js";
import "./chunk-7VFNBFXA.js";
import {
  require_react
} from "./chunk-PGVW4JXJ.js";
import "./chunk-P5DQEN3S.js";
import {
  __commonJS,
  __toESM
...
// ../../node_modules/.pnpm/@storybook+addon-docs@7.6.2_095c14d4c3f40d1d46de239de7c84c49/node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@storybook+blocks@7.6.20_@t_5ab7c4179b59fc489d3639cfa1536bec/node_modules/@storybook/blocks/dist/index.mjs
...
function _wrapNativeSuper(t2) {
  ...
  return _wrapNativeSuper = function _wrapNativeSuper2(t3) {
    ...
    return Wrapper10.prototype = Object.create(t3.prototype, {
      constructor: {
        value: Wrapper10,
        enumerable: false,
        writable: true,
...
// ../../node_modules/.pnpm/markdown-to-jsx@7.7.4_react@18.3.1/node_modules/markdown-to-jsx/dist/index.modern.js
...
`, { inline: t2 }));
  ...
  const q2 = [], Q2 = {}, V2 = { [r.blockQuote]: { match: Ie(u), order: 1, parse(e2, t2, n3) {
    const [, r2, i3] = e2[0].replace(p, "").match(f2);
...
// ../../node_modules/.pnpm/tocbot@4.35.0/node_modules/tocbot/src/js/build-html.js
function build_html_default(options2) {
  ...
  function createLink(data) {
    ...
    a2.setAttribute(
      "class",
      `${options2.linkClass + SPACE_CHAR}node-name--${data.nodeName}${SPACE_CHAR}${options2.extraLinkClasses}`
    );
    item.appendChild(a2);
    return item;
  }
  function createList(isCollapsed) {
    const listElement = options2.orderedList ? "ol" : "ul";
    const list = document.createElement(listElement);
    let classes = options2.listClass + SPACE_CHAR + options2.extraListClasses;
    if (isCollapsed) {
  ...
  function updateFixedSidebarClass() {
    ...
    const posFixedEl = document.querySelector(options2.positionFixedSelector);
    if (options2.fixedSidebarOffset === "auto") {
      options2.fixedSidebarOffset = tocElement.offsetTop;
    }
    if (scrollTop > options2.fixedSidebarOffset) {
  ...
  function updateToc(headingsArray, event) {
    ...
    if (shouldUpdate && !!tocElement && headings.length > 0) {
      ...
      const activeTocLink = tocElement.querySelector(
        `.${options2.linkClass}[href="${options2.basePath}#${activeId}"]`
      );
      if (oldActiveTocLink === activeTocLink) {
        return;
      }
      const tocLinks = tocElement.querySelectorAll(`.${options2.linkClass}`);
      forEach.call(tocLinks, (tocLink) => {
        updateClassname(
          tocLink,
          tocLink.className.replace(SPACE_CHAR + options2.activeLinkClass, "")
        );
      });
      const tocLis = tocElement.querySelectorAll(`.${options2.listItemClass}`);
      forEach.call(tocLis, (tocLi) => {
        updateClassname(
          tocLi,
          tocLi.className.replace(SPACE_CHAR + options2.activeListItemClass, "")
        );
      });
  ...
  function removeCollapsedFromParents(element) {
    if (element && element.className.indexOf(options2.collapsibleClass) !== -1 && element.className.indexOf(options2.isCollapsedClass) !== -1) {
      updateClassname(
        element,
        element.className.replace(SPACE_CHAR + options2.isCollapsedClass, "")
      );
  ...
  function getIsHeaderBottomMode(headerId) {
    ...
    const activeHeading = scrollEl == null ? void 0 : scrollEl.querySelector(`#${headerId}`);
    const isBottomMode = activeHeading.offsetTop > scrollEl.offsetHeight - scrollEl.clientHeight * 1.4 - options2.bottomModeThreshold;
    return isBottomMode;
  }
  function getIsPageBottomMode() {
    const scrollEl = getScrollEl();
    const isScrollable = scrollEl.scrollHeight > scrollEl.clientHeight;
    const isBottomMode = getScrollTop() + scrollEl.clientHeight > scrollEl.offsetHeight - options2.bottomModeThreshold;
    return isScrollable && isBottomMode;
  }
  function getScrollEl() {
    let el;
    if (options2.scrollContainer && document.querySelector(options2.scrollContainer)) {
      el = document.querySelector(options2.scrollContainer);
    } else {
  ...
  function getTopHeader(headings, scrollTop = getScrollTop()) {
    ...
    some.call(headings, (heading, i2) => {
      if (getHeadingTopPos(heading) > scrollTop + options2.headingsOffset + 10) {
...
// ../../node_modules/.pnpm/tocbot@4.35.0/node_modules/tocbot/src/js/default-options.js
...
// ../../node_modules/.pnpm/tocbot@4.35.0/node_modules/tocbot/src/js/parse-content.js
...
// ../../node_modules/.pnpm/tocbot@4.35.0/node_modules/tocbot/src/js/scroll-smooth/index.js
...
// ../../node_modules/.pnpm/tocbot@4.35.0/node_modules/tocbot/src/js/update-toc-scroll.js
function updateTocScroll(options2) {
  const toc = options2.tocScrollingWrapper || options2.tocElement || document.querySelector(options2.tocSelector);
  if (toc && toc.scrollHeight > toc.clientHeight) {
    const activeItem = toc.querySelector(`.${options2.activeListItemClass}`);
    if (activeItem) {
      const eTop = activeItem.offsetTop;
      const scrollAmount = eTop - options2.tocScrollOffset;
      toc.scrollTop = scrollAmount > 0 ? scrollAmount : 0;
    }
  }
}

// ../../node_modules/.pnpm/tocbot@4.35.0/node_modules/tocbot/src/js/index-esm.js
var _options = {};
var _buildHtml;
var _parseContent;
var _headingsArray;
...
function init(customOptions) {
  ...
  _scrollListener = throttle((e2) => {
    ...
    const isTop = ((_a = e2 == null ? void 0 : e2.target) == null ? void 0 : _a.scrollingElement) && e2.target.scrollingElement.scrollTop === 0;
...
function extend(...args2) {
  const target = {};
  for (let i2 = 0; i2 < args2.length; i2++) {
    const source2 = args2[i2];
    for (const key2 in source2) {
      if (hasOwnProp.call(source2, key2)) {
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-5RZEASJW.js");
...
var BooleanControl = ({ name: name2, value: value22, onChange, onBlur, onFocus }) => {
  ...
  if (value22 === void 0) return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name2), onClick: onSetFalse }, "Set boolean");
...
var ObjectControl = ({ name: name2, value: value22, onChange }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), !hasData) return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name2), onClick: onForceVisible }, "Set object");
...
var TextControl = ({ name: name2, value: value22, onChange, onFocus, onBlur, maxLength }) => {
  ...
  if (value22 === void 0) return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name2), onClick: onForceVisible }, "Set string");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-K4GP7KSM.js"));
...
var AnchorMdx = (props) => {
  ...
  if (href) {
    ...
    if (target !== "_blank" && !href.startsWith("https://")) return import_react.default.createElement(A2, { href, onClick: (event) => {
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-RY5QHP5L.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
telejson/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=DocsRenderer-NNNQARDV-4FUCF6N6.js.map
